...
// in notes_app_testing_starter/test/data/todo_local_data_source_test.dart.
...
import 'package:notes_app_testing_starter/data/models/todo.dart' as _i7;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBox extends _i1.Mock implements _i2.Box<_i7.Todo> {
  @override
  Iterable<_i7.Todo> get values => (super.noSuchMethod(
        Invocation.getter(#values),
        returnValue: <_i7.Todo>[],
        returnValueForMissingStub: <_i7.Todo>[],
      ) as Iterable<_i7.Todo>);
  ...
  @override
  Iterable<_i7.Todo> valuesBetween({
    dynamic startKey,
    dynamic endKey,
  }) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Todo? getAt(int? index) => (super.noSuchMethod(
        Invocation.method(
          #getAt,
          [index],
        ),
  ...
  @override
  Map<dynamic, _i7.Todo> toMap() => (super.noSuchMethod(
        Invocation.method(
          #toMap,
          [],
        ),
        returnValue: <dynamic, _i7.Todo>{},
        returnValueForMissingStub: <dynamic, _i7.Todo>{},
      ) as Map<dynamic, _i7.Todo>);
  ...
  @override
  _i3.Future<void> putAll(Map<dynamic, _i7.Todo>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #putAll,
          [entries],
  ...
  @override
  _i3.Future<int> add(_i7.Todo? value) => (super.noSuchMethod(
        Invocation.method(
          #add,
          [value],
        ),
  ...
  @override
  _i3.Future<Iterable<int>> addAll(Iterable<_i7.Todo>? values) =>
      (super.noSuchMethod(
        Invocation.method(
          #addAll,
          [values],
